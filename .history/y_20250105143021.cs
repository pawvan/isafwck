...
//scaffold identity ui (optional) 
dotnet aspnet-codegenerator-identity -dc ApplicationDbContext
//use identity in controllers 
public class AccountController :Controller{
    private readonly UserManager<IdentityUser> _userManager;
    private readonly SignInManager<IdentityUser> _signInManager;
    public AccountController(UserManager<IdentityUser> userManager ,SignInManager);{
        _userManager=userManager;
        _signInManager=SignInManager
    }
[HttpPost("register")]
public sync Task<IActionResult> Register(string email,string password){
...
//role based authorization//assign roles to user and restrict access based on roles 
//1.assign roles
...
public IActionResult GetAdminData(){
    return Ok("This resource for admins only");
}
//policy based authorization 
//define custom authorization poolicices

//1.configure policies 
builder.Services.AddAuthorization(options=>options.AddPolicy("RequireAdmin"),policy =>policy.ReadFileequire)